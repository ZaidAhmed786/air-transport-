    ...
    return (
      <>
        <ul className="navigation clearfix">
          ...
          {/* <li className="dropdown">
            <Link href="/page-product">Shop</Link>
            <ul style={{ display: `${isActive.key == 6 ? "block" : "none"}` }}>
              <li>
                <Link href="/page-product">Shop Grid</Link>
              </li>
              <li>
                <Link href="/shop-product-details">Shop Details</Link>
              </li>
              <li>
                <Link href="/shop-products-sidebar">Shop Sidebar</Link>
              </li>
              <li>
            ...
            <div className="dropdown-btn" onClick={() => handleClick(6)}>
              <i className="fa fa-angle-down" />
            </div>
          </li> */}
